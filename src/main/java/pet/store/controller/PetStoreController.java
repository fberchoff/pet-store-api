...
public class PetStoreController {
	...
	@ResponseStatus(code = HttpStatus.CREATED)
	public EmployeeData insertEmployee(@PathVariable Long petStoreId
			                   , @RequestBody EmployeeData employeeData) {		
		log.info("Creating employee {} for pet store with ID={}", employeeData, petStoreId);		
	...
	@ResponseStatus(code = HttpStatus.CREATED)
	public CustomerData insertCustomer(@PathVariable Long petStoreId
			                   , @RequestBody CustomerData customerData) {		
		log.info("Creating customer {} for pet store with ID={}", customerData, petStoreId);		
